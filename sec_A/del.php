    ...
    <div class="container">
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <select class="form-control" id="incorp_data" name="incorp_date" required></select>
        </div>
        <script>
          var start = 1900;
          var end = 2023;
          ...
          document.getElementById("incorp_data").innerHTML = options;
        </script>
        <!-- Year End -->
        ...
        <div class="mb-3 container">
          ...
          <div id="doba">
            <table>
              ...
              <tbody>
                <tr>
                  <td style="width:8%;"><input type="number" id="doba" name="doba[]" class="table-control" required value="1" readonly></td>
