        ...
        <div class="mb-3">
            ...
            <div id="doba">
                <table>
                    ...
                    <tr>
                        <td style="width:8%;"><input type="number" name="doba[]" class="table-control" required value="1" readonly></td>
                        <td><input type="text" name="doba[]" class="form-control" required></td>
                        <td><input type="text" name="doba[]" class="form-control" required></td>
                        <td><input type="text" name="doba[]" class="form-control" required></td>
                        <td>
                            <button class="add-remove-row-btn" type="button" onclick="addRow()">+</button>
                            <button class="add-remove-row-btn" type="button" onclick="removeRow(this)">-</button>
                        </td>
                    </tr>
                </table>
            </div>
